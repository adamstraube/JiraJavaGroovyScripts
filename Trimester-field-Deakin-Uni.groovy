...
switch(year) {
  ...
  case 2015:
    ...
    endT3d = new DateMidnight((int)year, 2, 20);
   	startT1d = new DateMidnight((int)year, 3, 9);
 	endT1d = new DateMidnight((int)year, 6, 19);
    	startT2d = new DateMidnight((int)year, 7, 14);
 	endT2d = new DateMidnight((int)year, 10, 24);
 	startT3d = new DateMidnight((int)year, 11, 10);   
  ...
  case 2016:
	...
	endT3d = new DateMidnight((int)year, 2, 19);
        startT1d = new DateMidnight((int)year, 3, 7);
        endT1d = new DateMidnight((int)year, 6, 17);
        startT2d = new DateMidnight((int)year, 7, 11);
        endT2d = new DateMidnight((int)year, 10, 21);
        startT3d = new DateMidnight((int)year, 11, 7);
  ...
  case 2017:
        ...
        endT3d = new DateMidnight((int)year, 2, 17);

        LocalDate endT3 = endT3d.toLocalDate();

        if (endT3.isAfter(dtIssue))
        {
                trimesterString = 'T3-2016';
                break;
        }
        else
        {
